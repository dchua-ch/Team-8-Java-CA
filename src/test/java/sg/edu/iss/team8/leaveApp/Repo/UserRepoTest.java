...
//		
//		Leave leave4 = new Leave(LocalDate.parse("2020-01-07"), LocalDate.parse("2020-01-10"),LeaveEnum.ANNUAL , "...",
...
//		
//		Leave leave7 = new Leave(LocalDate.parse("2020-01-06"), LocalDate.parse("2020-01-10"),LeaveEnum.ANNUAL , "...",
...
//		Leave leave9 = new Leave(LocalDate.parse("2020-01-01"), LocalDate.parse("2020-01-09"),LeaveEnum.MEDICAL , "...",
//				"...", "93333", StatusEnum.APPROVED, "...", employee1);
//		Leave leave10 = new Leave(LocalDate.parse("2020-01-09"), LocalDate.parse("2020-01-15"),LeaveEnum.ANNUAL , "...",
//				"...", "93333", StatusEnum.UPDATED, "...", employee1);
//		employee1.addLeave(leave7);
//		employee1.addLeave(leave8);
//		employee1.addLeave(leave9);
//		employee1.addLeave(leave10);
//		
//		Leave leave11 = new Leave(LocalDate.parse("2020-01-11"), LocalDate.parse("2020-01-15"),LeaveEnum.ANNUAL , "...",
//				"...", "94444", StatusEnum.APPLIED, "...", employee2); 
//		Leave leave12 = new Leave(LocalDate.parse("2020-05-08"), LocalDate.parse("2020-05-12"),LeaveEnum.ANNUAL , "...",
//				"...", "94444", StatusEnum.APPLIED, "...", employee2); 
//		Leave leave13 = new Leave(LocalDate.parse("2020-01-08"), LocalDate.parse("2020-01-10"),LeaveEnum.COMPENSATION , "...",
//				"...", "94444", StatusEnum.DELETED, "...", employee2); 
//		Leave leave14 = new Leave(LocalDate.parse("2020-01-08"), LocalDate.parse("2020-01-10"),LeaveEnum.MEDICAL , "...",
//				"...", "94444", StatusEnum.APPROVED, "...", employee2);
//		Leave leave15 = new Leave(LocalDate.parse("2020-01-08"), LocalDate.parse("2020-01-09"),LeaveEnum.COMPENSATION , "...",
//				"...", "94444", StatusEnum.APPLIED, "...", employee2);
//		employee2.addLeave(leave11);
//		employee2.addLeave(leave12);
//		employee2.addLeave(leave13);
//		employee2.addLeave(leave14);
//		employee2.addLeave(leave15);
//		
//		Leave leave16 = new Leave(LocalDate.parse("2020-01-08"), LocalDate.parse("2020-01-10"),LeaveEnum.ANNUAL , "...",
//				"...", "95555", StatusEnum.APPLIED, "...", employee3); 
//		Leave leave17 = new Leave(LocalDate.parse("2020-05-01"), LocalDate.parse("2020-05-07"),LeaveEnum.COMPENSATION , "...",
//				"...", "95555", StatusEnum.DELETED, "...", employee3); 
//		Leave leave18 = new Leave(LocalDate.parse("2020-01-08"), LocalDate.parse("2020-01-10"),LeaveEnum.MEDICAL , "...",
//				"...", "95555", StatusEnum.APPROVED, "...", employee3);
//		employee3.addLeave(leave16);
//		employee3.addLeave(leave17);
//		employee3.addLeave(leave18);
//		
//		
